...
def menu(message: telebot.types.Message):
    ...
    keyboard.add(button_glazing, button_balcony, button_contacts, button_portfolio)
...
def glazing(message):
    ...
    keyboard.add(button_glazing_kvartira, button_glazing_dom, button_glazing_office, button_glazing_other,button_glazing_back )
    bot.send_message(chat_id, 'Куда хотите установить окна?', reply_markup=keyboard)
...
def glazing_type(message):
    ...
    button_glazing_back = telebot.types.KeyboardButton(text="Назад")
    keyboard.add(button_glazing_kv_window, button_glazing_balcony_block, button_glazing_enter_block, button_glazing_back)
    bot.send_message(chat_id, 'Какой тип изделия?', reply_markup=keyboard)
...
def glazing_profile(message):
    ...
    keyboard.add(button_glazing_rehau, button_glazing_kbe, button_glazing_brusbox,button_glazing_consultation, button_glazing_profile_back)
    bot.send_message(chat_id, 'Выберите профиль', reply_markup=keyboard)
...
def glazing_size(message):
    ...
    keyboard.add(button_glazing_size_yes, button_glazing_size_no, button_glazing_size_back )
    bot.send_message(chat_id, ' Можете указать размеры изделий?', reply_markup=keyboard)
...
def balcony(message):
    ...
    keyboard.add(button_balcony_hot, button_balcony_cold, button_balcony_slidors,button_balcony_back )
    bot.send_message(chat_id, 'Выберите тип остекления:', reply_markup=keyboard)
...
def balcony_form(message):
    ...
    keyboard.add(button_form_1, button_form_2, button_form_3, button_form_4, button_form_5, button_form_back )
    bot.send_message(chat_id, 'Какая у вас форма балкона?', reply_markup=keyboard)
...
def balcony_type(message):
    ...
    keyboard.add(button_type_1, button_type_2, button_type_3, button_type_back )
    bot.send_message(chat_id, 'Нужна ли обшивка?', reply_markup=keyboard)
...
def balcony_insulation(message):
    ...
    keyboard.add(button_insulation_type_1, button_insulation_type_2, button_insulation_type_3, button_insulation_back)
    bot.send_message(chat_id, 'Утепление требуется?', reply_markup=keyboard)
...
def balcony_size(message):
    ...
    keyboard.add(button_balcony_size_1, button_balcony_size_2, button_balcony_size_back)
    bot.send_message(chat_id, 'Указать размеры?', reply_markup=keyboard)
    bot.register_next_step_handler(message, adress)
...
def contacts(message):
    ...
    keyboard.add(button_gcontacts_back )
    bot.send_message(chat_id, '📍 Наши контакты:'
                              'ул. Центральная, д. 10'
                              '📱 +7 (900) 000-00-00'
                              '✉ info@okna.ru'
                              '📲 WhatsApp: https://wa.me/79000000000'
                              '📲 Telegram: https://t.me/okna_manager', reply_markup=keyboard)
    bot.register_next_step_handler(message, glazing_type)
